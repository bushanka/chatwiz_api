...
from llm.apgvector.test_embedd import test_embed
...
class AsyncPgVector:
    ...
    def _convert_records_to_document(self, records) -> List[Document]:
        docs = [        
            Document(
    ...
    async def similarity_search(self, query: str, collection_name: str, k: int = 5) -> List[Document]:
        ...
        return self._convert_records_to_document(res)
